...
Date           : 2023-05-18 10:47:35
Last Revision  : 2023-05-28 23:10:45
Last Author    : Jie Li
File Path      : /AI-assisstedChangePointDetection/Python/RNWeak21T2N2500R10SaveForR.py
Description    :
...
data_xpath = datapath + "RNWeak21R10data_x"
np.save(data_xpath, data_x)
cpt_varpath = datapath + "RNWeak21R10cpt_var"
np.save(cpt_varpath, cp_var)
cpt_slopepath = datapath + "RNWeak21R10cpt_slope"
np.save(cpt_slopepath, cp_slope)
cpt_meanpath = datapath + "RNWeak21R10cpt_mean"
np.save(cpt_meanpath, cp_mean)
data_x_testpath = datapath + "RNWeak21R10data_x_test"
np.save(data_x_testpath, x_test)
data_y_testpath = datapath + "RNWeak21R10data_y_test"
