...
# Date           : 2023-05-18 10:42:43
# Last Revision  : 2023-05-28 23:13:27
# Last Author    : Jie Li
# File Path      : /AI-assisstedChangePointDetection/R/RNStrongoracle-revisionTestR10.r
# Description    :
#
#  LR-test in R
...
data_x <- npyLoad("../datasets/BICRevision/RNStrong21R10data_x_test.npy")
data_y <- npyLoad("../datasets/BICRevision/RNStrong21R10data_y_test.npy", type = "integer")
n <- dim(data_x)[1]
pred_y <- rep(0, n)
...
npySave("../datasets/BICRevision/RNStrong21R10Result.npy", cbind(data_y, pred_y, pred_y_bic))
print("ResNet")
c(498 / sum(data_y == 0), 494 / sum(data_y == 1), 494 / sum(data_y == 2), 460 / sum(data_y == 3), 472 / sum(data_y == 0))
print((498 + 494 + 494 + 460 + 472) / n)
