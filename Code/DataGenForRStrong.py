...
Date           : 2022-10-29 21:47:08
Last Revision  : 2022-10-29 23:11:08
Last Author    : Jie Li
File Path      : /AutoCPD/Code/DataGenForRStrong.py
Description    : 
...
fname_x_test_r = datapath + "x_test_rstrong"
x_test_r = x_test[:, 0, :]
np.save(fname_x_test_r, x_test_r)
fname_y_test = datapath + "y_test_rstrong"
