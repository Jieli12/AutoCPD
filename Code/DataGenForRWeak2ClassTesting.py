...
Date           : 2023-05-02 23:22:41
Last Revision  : 2023-09-04 11:21:50
Last Author    : Jie Li
File Path      : /AutoCPD/Code/DataGenForRWeak2ClassTesting.py
Description    :


2 class, test for weak SNR

Table R1, weak, ResNet, double-checked
...
# %%
# LR method
opt_th = np.load("../datasets/CusumResult/opt_th_mean_var_weak.npy")
# Both
...
path_th = "../datasets/CusumResult/acc_mean_var_weak30"
np.save(
	path_th,
	np.array(
		[
...
path_th = "../datasets/CusumResult/acc_nn21_weak30"
