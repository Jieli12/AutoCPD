...
Date           : 2023-05-04 13:53:34
Last Revision  : 2023-09-04 15:38:22
Last Author    : Jie Li
File Path      : /AutoCPD/Code/DS1WeakResult.py
Description    :

Detection, weak SNR, n=300,400,500,600; n_prime=2000, tau_bound=750, N_prime=500
S1 with B_bound=[0.5, 1.5]
Compute Result
...
for j, n, m in zip(range(len(n_candidates)), n_candidates, m_candidate):
	...
	rmse[j, :] = rmse_tmp
np.save("../datasets/CusumResult/DS1Weak", rmse)
np.round(rmse, 2)
