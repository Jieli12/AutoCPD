...
Date           : 2023-05-08 20:11:44
Last Revision  : 2023-09-04 16:52:02
Last Author    : Jie Li
File Path      : /AutoCPD/Code/DS3WeakResultWilcoxR.py
Description    :
...
for j, n, m in zip(range(len(n_candidates)), n_candidates, m_candidate):
	...
	data_name = "../datasets/RWilcoxon/DS3Weak" + "n" + str(n)
	np.save(data_name, data)
	cpt_name = "../datasets/RWilcoxon/DS3Weakcpt" + "n" + str(n)
