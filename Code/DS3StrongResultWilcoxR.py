...
Date           : 2023-05-08 20:13:07
Last Revision  : 2023-09-04 16:43:43
Last Author    : Jie Li
File Path      : /AutoCPD/Code/DS3StrongResultWilcoxR.py
Description    :
...
for j, n, m in zip(range(len(n_candidates)), n_candidates, m_candidate):
	...
	data_name = "../datasets/RWilcoxon/DS3Strong" + "n" + str(n)
	np.save(data_name, data)
	cpt_name = "../datasets/RWilcoxon/DS3Strongcpt" + "n" + str(n)
