...
Date           : 2023-05-08 19:58:45
Last Revision  : 2023-09-04 16:51:36
Last Author    : Jie Li
File Path      : /AutoCPD/Code/DS1WeakResultWilcoxR.py
Description    :
...
for j, n, m in zip(range(len(n_candidates)), n_candidates, m_candidate):
	...
	data_name = "../datasets/RWilcoxon/DS1Weak" + "n" + str(n)
	np.save(data_name, data)
	cpt_name = "../datasets/RWilcoxon/DS1Weakcpt" + "n" + str(n)
