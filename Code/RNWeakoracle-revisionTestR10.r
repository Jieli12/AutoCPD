...
# Last Revision  : 2023-06-11 21:09:54
# Last Author    : Jie Li
# File Path      : /AutoCPD/Code/RNWeakoracle-revisionTestR10.r
# Description    :
#
#
#  LR-test in R
...
data_x <- npyLoad("../datasets/BIC/RNWeak21R10data_x_test.npy")
data_y <- npyLoad("../datasets/BIC/RNWeak21R10data_y_test.npy", type = "integer")
n <- dim(data_x)[1]
pred_y <- rep(0, n)
