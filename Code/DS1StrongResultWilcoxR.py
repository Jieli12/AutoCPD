...
Date           : 2023-05-08 18:09:09
Last Revision  : 2023-09-04 16:43:55
Last Author    : Jie Li
File Path      : /AutoCPD/Code/DS1StrongResultWilcoxR.py
Description    :
...
for j, n, m in zip(range(len(n_candidates)), n_candidates, m_candidate):
	...
	data_name = "../datasets/RWilcoxon/DS1Strong" + "n" + str(n)
	np.save(data_name, data)
	cpt_name = "../datasets/RWilcoxon/DS1Strongcpt" + "n" + str(n)
	np.save(cpt_name, tau_all)
