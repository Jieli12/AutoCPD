...
Date           : 2023-05-04 20:41:48
Last Revision  : 2023-09-04 16:55:26
Last Author    : Jie Li
File Path      : /AutoCPD/Code/DS1StrongResultMosumAdjust.py
Description    :
...
np.save("../datasets/CusumResult/DS1StrongMosumAdjust", rmse)
# np.save("DS1StrongMosumAdjust", rmse)
np.round(rmse, 2)
