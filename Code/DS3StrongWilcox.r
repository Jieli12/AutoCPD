...
# Date           : 2023-05-08 20:18:17
# Last Revision  : 2023-09-04 16:49:09
# Last Author    : Jie Li
# File Path      : /AutoCPD/Code/DS3StrongWilcox.r
# Description    :
#
#
#
...
for (i in 1:4) {
    n <- nn[i]
    data_name <- paste("../datasets/RWilcoxon/DS3Strong", "n", as.character(n), ".npy", sep = "")
    cpt_name <- paste("../datasets/RWilcoxon/DS3Strongcpt", "n", as.character(n), ".npy", sep = "")
...
npySave("../datasets/RWilcoxon/DS3StrongRMSE.npy", rmse)
