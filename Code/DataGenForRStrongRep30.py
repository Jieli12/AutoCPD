...
Date           : 2022-10-30 15:41:43
Last Revision  : 2022-10-30 15:44:28
Last Author    : Jie Li
File Path      : /AutoCPD/Code/DataGenForRStrongRep30.py
Description    :
...
fname_x_test_r = datapath + "x_test_allstrong_rep30"
np.save(fname_x_test_r, x_test)
fname_x_test_r = datapath + "x_test_rstrong_rep30"
x_test_r = x_test[:, 0, :]
np.save(fname_x_test_r, x_test_r)
fname_y_test = datapath + "y_test_rstrong_rep30"
