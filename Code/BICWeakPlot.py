...
Date           : 2022-10-29 22:51:42
Last Revision  : 2022-10-29 23:11:35
Last Author    : Jie Li
File Path      : /AutoCPD/Code/BICWeakPlot.py
Description    :
...
# %%
# only use BIC
fname_y_pred_bic = datapath + "y_pred_bic_rweak" + ".npy"
fname_y_test = datapath + "y_test_rweak" + ".npy"
...
print(acc)
cm_nameeps = datapath + 'Confusion_matrixBIC_weak' + '.eps'
cm_namepng = datapath + 'Confusion_matrixBIC_weak' + '.png'
