...
Last Revision  : 2022-05-10 08:18:17
Last Author    : Jie Li
File Path      : /AI-assisstedChangePointDetection/Python/ResNetN1kE8tanhDecay10kScale.py
Description    : based on ResNetN1kE8tanhDecay10k.py but rescale:
				use the function Transform2D(rescale, cumsum)
