...
Date           : 2022-05-11 11:04:27
Last Revision  : 2022-10-10 15:55:35
Last Author    : Jie Li
File Path      : /AI-assisstedChangePointDetection/Python/RealDataCPDTestNewSeq2.py
Description    : based on RealDataCPDTestNew.py, the second sequence
...
for i in range(len(label)):
	...
	if i == 0:
		...
		x_pos = (np.mean(cp[i:i + 2]) - xlim[0] / 3) / x_range
...
fig_name = Path(
	project_path,
	'Latex/JRSSB-Discussion-Manuscript/figures/RealDataCPDEst2.eps'
)
