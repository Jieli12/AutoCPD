...
Date           : 2022-10-23 10:14:32
Last Revision  : 2022-10-23 10:51:29
Last Author    : Jie Li
File Path      : /AI-assisstedChangePointDetection/Python/ScenarioDRhoRandomPredict.py
Description    :
...
markers = ['o', 'v', '*', 'd']
for i in range(4):
	plt.plot(N_vec, mean_mer[i, :], linewidth=2, marker=markers[i])

plt.legend(['CUSUM', r"$m_1$", r"$m_2$", r"$m_3$"], fontsize=14)
plt.xlabel('N', fontsize=20)
plt.ylabel('MER Average', fontsize=20)
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)

cm_name = current_file + 'MERAverage.eps'
